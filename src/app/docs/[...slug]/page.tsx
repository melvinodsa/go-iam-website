...
export default async function Docs({
  ...
  return (
    <Row>
            ...
            <Row fillWidth s={{ horizontal: "stretch" }}>
              <Row maxWidth={20}>
                <Card
                  ...
                  href={`/docs/${prevPage ? prevPage.slug : ''}`}
                  radius="l"
                  paddingX="16"
                >
                  ...
                  <Column gap="4" vertical="center" paddingX="16" paddingY="12">
                    <Text variant="label-default-s" onBackground="neutral-weak">
                      {prevPage && prevPage.slug.includes('/') ?
                    ...
                    <Text onBackground="neutral-strong" variant="heading-strong-m" wrap="balance">
                      {prevPage ? prevPage.metadata.title : 'Getting Started'}
                    </Text>
                  </Column>
                </Card>
              </Row>
      ...
      <Column gap="16" maxWidth={layout.sideNav.width} m={{ hide: true }} position="sticky" top="80" overflow="auto" style={{ height: "calc(100vh - var(--static-space-80)*2)" }}>
